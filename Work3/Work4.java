...
public class Work4 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == calcBtn) {
            ...
            sum = p1 + p2 + p3 + p4 + p5 + carRPor + carRBal + carRPol + carRMon + carRSpa + roomRPor + roomRBal
                    + roomRPol + roomRMon + roomRSpa;

            // Display =====================================
            lbl6.setText("1) แพ็คเกจทัวร์ประเทศโปรตุเกส ราคา 50,000 บาท / คน จำนวน " + (int) q1 + " คน = " + (int) p1
                    + " บาท เช่ารถ " + (int) carRPor + " บาท ห้องพัก " + (int) roomRPor + " บาท");
            lbl7.setText("2) แพ็คเกจทัวร์ประเทศบัลแกเรีย ราคา 49,000 บาท / คน จำนวน " + (int) q2 + " คน = " + (int) p2
                    + " บาท เช่ารถ " + (int) carRBal + " บาท ห้องพัก " + (int) roomRBal + " บาท");
            lbl8.setText("3) แพ็คเกจทัวร์ประเทศโปแลนด์ ราคา 48,000 บาท / คน จำนวน " + (int) q3 + " คน = " + (int) p3
                    + " บาท เช่ารถ " + (int) carRPol + " บาท ห้องพัก " + (int) roomRPol + " บาท");
            lbl9.setText("4) แพ็คเกจทัวร์ประเทศโมนาโก ราคา 47,000 บาท / คน จำนวน " + (int) q4 + " คน = " + (int) p4
                    + " บาท เช่ารถ " + (int) carRMon + " บาท ห้องพัก " + (int) roomRMon + " บาท");
            lbl10.setText("5) แพ็คเกจทัวร์ประเทศสเปน ราคา 46,000 บาท / คน จำนวน " + (int) q5 + " คน = " + (int) p5
                    + " บาท เช่ารถ " + (int) carRSpa + " บาท ห้องพัก " + (int) roomRSpa + " บาท");
